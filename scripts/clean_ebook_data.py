...
Usage:
    python scripts/clean_ebook_data.py <path>          # dry-run  — liste ce qui sera supprimé
    python scripts/clean_ebook_data.py <path> --delete  # suppression réelle
"""
...
def main():
    ...
    if not args:
        sys.exit("Usage: python scripts/clean_ebook_data.py <path> [--delete]")
